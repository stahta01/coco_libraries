...
DVEC1           BLE         NEAREST_RTS     ; RETURN IF NOT A DISK FILE
...
DVEC2           TST         DEVNUM          ; CHECK DEVICE NUMBER AND
                BLE         NEAREST_RTS     ; RETURN IF NOT DISK FILE
...
LCE68           BSR         DKACCDTOFPA0    ; PUT ACCD INTO FPA0
...
LCE72           JSR         >LBC5F          ; SAVE NUMBER OF BYTES IN FULL SECTORS IN FPA1
                ...
                BSR         DKACCDTOFPA0    ; PUT NUMBER BYTES IN LAST SECTOR INTO FPA0
                ...
                LDD         FCBRLN,X        ; GET RECORD LENGTH
                BSR         DKACCDTOFPA0    ; PUT IT INTO FPA0
